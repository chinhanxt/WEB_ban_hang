...
<div class="reveal-up mb-4">
    <div class="section-kicker"><i class="fa-solid fa-credit-card"></i>Thanh toán</div>
    <h1 class="section-title mb-2">Hoàn tất đặt hàng</h1>
    <p class="section-subtitle mb-0">Thông tin giao hàng và tóm tắt đơn được đặt cạnh nhau để bạn kiểm tra nhanh trước khi xác nhận.</p>
</div>

<?php if (!empty($errors)): ?>
    <div class="surface-card p-3 mb-4" style="border-left: 4px solid var(--danger-color);">
        <ul class="mb-0">
...
<div class="row">
    ...
    <div class="col-md-7">
        <div class="surface-card p-4 reveal-up stagger-1">
            ...
            <form method="POST" action="/webbanhang/ProductController/placeOrder">
                ...
                <div class="form-group mb-3">
                    ...
                    <input type="text" name="name" class="form-control" required placeholder="Nhập họ và tên người nhận" value="<?php echo isLoggedIn() ? htmlspecialchars($_SESSION['user']->fullname) : ''; ?>">
                </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group mb-3">
                            ...
                            <input type="tel" name="phone" class="form-control" required pattern="[0-9]{10,11}" title="Vui lòng nhập số điện thoại từ 10-11 chữ số" placeholder="Ví dụ: 0987654321">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group mb-3">
                            <label class="small font-weight-bold text-muted">Email (Không bắt buộc)</label>
                            <input type="email" name="email" class="form-control" placeholder="example@gmail.com" value="<?php echo isLoggedIn() ? htmlspecialchars($_SESSION['user']->email) : ''; ?>">
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group mb-3">
                    ...
                    <textarea name="address" class="form-control" required rows="3" placeholder="Số nhà, tên đường, phường/xã, quận/huyện, tỉnh/thành phố"></textarea>
                </div>
                ...
                <div class="form-group mb-4">
                    ...
                    <div class="row">
                        <div class="col-6">
                            <div class="custom-control custom-radio payment-option p-3 rounded border">
                ...
                <div class="form-group mb-4">
                    ...
                    <textarea name="notes" class="form-control" rows="2" placeholder="Dặn dò shipper hoặc cửa hàng..."></textarea>
                </div>
    ...
    <div class="col-md-5">
        <div class="surface-card p-4 reveal-up stagger-2">
        ...
        <div class="soft-panel mt-4 p-3" style="border-left: 5px solid #28a745;">
...
<style>
    .payment-option { transition: all 0.2s ease; cursor: pointer; background: rgba(255,255,255,0.8); }
    .payment-option:hover { background: #fff7ed !important; border-color: rgba(249, 115, 22, 0.2) !important; }
